...
import com.code.art.base.structure3.graph.base.MinHeap;
import com.code.art.base.structure3.graph.base.UnionFind;
...
public class KruskalMST<Weight extends Number & Comparable> {
    ...
    public static void main(String[] args) {
        ...
        String filename = GraphConst.FILE_PATH_02 + "testG1.txt";
        int V = 8;
