package com.code.art.base.structure3.graph.tools03;
...
import com.code.art.base.structure3.graph.tools02.ReadWeightedGraph;

import java.util.Stack;
import java.util.Vector;

/**
 * 描述: 使用BellmanFord算法求最短路径
 *
 * @author zhourao
 * @create 2021-04-04 1:11 下午
 */
public class BellmanFord<Weight extends Number & Comparable> {
    ...
    public static void main(String[] args) {
        ...
        String filename = GraphConst.FILE_PATH_03 + "testG2.txt";
        //String filename = GraphConst.FILE_PATH_03 + "testG_negative_circle.txt";
