 ...
 *
 * @author zhourao
 * @create 2021-06-13 9:00 上午
 */
public class MineSweeperData {

    public static final String blockImageURL = "src/main/resources/mine/block.png";
    public static final String flagImageURL = "src/main/resources/mine/flag.png";
    public static final String mineImageURL = "src/main/resources/mine/mine.png";

    public static String numberImageURL(int num) {
        if (num < 0 || num > 8) {
            throw new IllegalArgumentException("No such a number image!");
        }
        return "src/main/resources/mine/" + num + ".png";
    }
    ...
    public boolean isMine(int x, int y) {
        if (!inArea(x, y)) {
            throw new IllegalArgumentException("Out of index in isMine fuction");
        }
        return mines[x][y];
    }
    ...
    public int getNumber(int x, int y) {
        if (!inArea(x, y)) {
            throw new IllegalArgumentException("Out of index in getNumber fuction");
        }
        return numbers[x][y];
    }
